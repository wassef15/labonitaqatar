    ...
    <>
      ...
      <section className="relative h-[85vh] md:h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center text-white px-6 space-y-8">
          ...
          <h1 className="text-3xl md:text-7xl font-light tracking-wide">
      ...
      {/* INTRO */}
      <section className="py-20 md:py-24 max-w-4xl mx-auto px-6 md:px-8 text-center space-y-6 reveal">
      ...
      <section
        ref={containerRef}
        className="pb-20 md:pb-32 space-y-20 md:space-y-24 max-w-6xl mx-auto px-6 md:px-8"
      >

        {services.map((service, index) => (
          <div
            key={index}
            className={`grid md:grid-cols-2 gap-12 md:gap-16 items-center reveal ${
          ...
          >
            ...
            {/* IMAGE */}
            <div
              className={`relative w-full aspect-[4/5] overflow-hidden shadow-xl border border-[var(--color-beige)] bg-white ${
      ...
      {/* CTA */}
      <section className="py-20 md:py-24 bg-[#141414] text-white text-center px-6 space-y-6">
